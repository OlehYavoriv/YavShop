...
const FAQ = () => {
  return (
    <div className={styles.faq}>
      <h2 className={styles.page__title}>Faq</h2>
      ...
      <div className={styles.content}>
        <details className={styles.question}>
          <summary className={styles.label}>User agreement</summary>

          <div className={styles.collapse}>
            I (hereinafter - "I" and / or "User") agree to the terms of this
            User Agreement and using the site: rozetka.com.ua (hereinafter -
            "Site") and / or mobile application YavShop (hereinafter - "Mobile
            Application") ) and / or other services (hereinafter collectively
            referred to as "YavShop Online Platform" and / or "Online
            Platform"), when ordering, correspondence, telephone conversation,
            leaving feedback, etc., I consent to the processing and protection
            of my personal data , as the User, in the amount, in accordance with
            the purpose of processing in accordance with the Regulations on
            personal data processing posted here: (hereinafter - "Regulations"
            and / or "Regulations on processing and protection of personal
            data").
          </div>
        </details>
        ...
        <details className={styles.question}>
          ...
          <div className={styles.collapse}>
            The description of the goods posted on the Online platform,
            including the prices indicated on the Online platform and
            information on the availability of goods, may change. The amount of
            the order may vary depending on the price, quantity, range of goods
            available from the seller on the date of shipment. The final value
            of the goods is indicated in the settlement and / or accompanying
            documents provided to the buyer (or his representative) upon receipt
            of the order. In case of absence of the goods the seller can
            unilaterally cancel the order.
          </div>
        </details>
      </div>
    </div>
